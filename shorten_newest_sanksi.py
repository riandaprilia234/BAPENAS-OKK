...
long_url = "https://docs.google.com/forms/d/e/1FAIpQLSdJ3iXdlk0nKRPiIlT_L-ftzEIiHopchf3NJSmij-ekvJrp7w/viewform"
aliases = [
    "FormSanksiOKK26",
    "FormPengumpulanSanksi2026",
    "LinkSanksiOKK2026",
    "SanksiBapenas2026"
]
...
if short_url:
    ...
    # We want to replace whatever previous sanksi links were there
    # Let's search for "tinyurl.com/Form" or "tinyurl.com/FormSanksi" and replace it
    # We will do a generic replacement of previous links
    
    # Update txt file
    txt_file = os.path.join(search_dir, "LINK PENGUMPULAN SANKSI OKK.txt")
    try:
        # Read old link just in case
        old_link = ""
        if os.path.exists(txt_file):
            old_link = open(txt_file).read().strip()
        ...
        replacements = {
            "tinyurl.com/FormSanksiOKK2026": short_url.replace("https://", ""),
        ...
        if old_link:
            replacements[old_link.replace("https://", "")] = short_url.replace("https://", "")
